...
func TestGenerateErrorIfPackageNotFound(t *testing.T) {
...
func TestGenerateErrorIfTypeNotFound(t *testing.T) {
	fixture := map[string]*pkgFuncs{
		"github.com/MyNihongo/inject/examples/pkg1": {
			alias: "pkg1",
			funcs: map[typeNameDecl]*funcDecl{
...
func TestGenerateErrorInconsistentInjection(t *testing.T) {
	fixture := map[string]*pkgFuncs{
		"github.com/MyNihongo/inject/examples/pkg1": {
			alias: "pkg1",
			funcs: map[typeNameDecl]*funcDecl{
...
func TestGenerateNotFoundNotPointer(t *testing.T) {
	fixture := map[string]*pkgFuncs{
		"github.com/MyNihongo/inject/examples/pkg1": {
			alias: "pkg1",
			funcs: map[typeNameDecl]*funcDecl{
					...
					paramDecls: []*typeDecl{
						{
							...
							typeName: typeNameDecl{
								typeName:  "Service2",
								isPointer: false, // type registered as a pointer
							},
						},
					},
				},
		...
		"github.com/MyNihongo/inject/examples/pkg2": {
			alias: "pkg2",
			funcs: map[typeNameDecl]*funcDecl{
				{typeName: "Service2", isPointer: true}: {
					name:       "GetService2",
	...
	assert.Nil(t, file)
	assert.Error(t, err, "type Service2 is not found in the package github.com/MyNihongo/inject/examples/pkg2")
}

func TestGenerateTransientSingle(t *testing.T) {
...
func TestGenerateSingletonSingle(t *testing.T) {
	const want = `// Code generated by my-nihongo-di. DO NOT EDIT.
package di
...
func TestGenerateInjectTransientTwo(t *testing.T) {
	const want = `// Code generated by my-nihongo-di. DO NOT EDIT.
package di
...
func TestGenerateInjectSingletonTwo(t *testing.T) {
	const want = `// Code generated by my-nihongo-di. DO NOT EDIT.
package di
...
func TestGenerateInjectSingletonIntoTransient(t *testing.T) {
	const want = `// Code generated by my-nihongo-di. DO NOT EDIT.
package di
...
func TestGenerateInjectPointer(t *testing.T) {
	const want = `// Code generated by my-nihongo-di. DO NOT EDIT.
package di
...
`
	...
	fixture := map[string]*pkgFuncs{
		"github.com/MyNihongo/inject/examples/pkg1": {
			alias: "pkg1",
			funcs: map[typeNameDecl]*funcDecl{
				{typeName: "Service1", isPointer: true}: {
					name:       "GetService1",
					injectType: Transient,
					paramDecls: []*typeDecl{
						{
		...
		"github.com/MyNihongo/inject/examples/pkg2": {
			alias: "pkg2",
			funcs: map[typeNameDecl]*funcDecl{
				{typeName: "Service3", isPointer: true}: {
					name:       "GetService3",
					injectType: Transient,
					paramDecls: []*typeDecl{},
				},
